...
Date: 2024-06-05
Description: This script plays a video with frame numbers displayed on each frame by:
...
- Tkinter (`tk` and `simpledialog`): Used for GUI dialogs to input frame number.
"""
