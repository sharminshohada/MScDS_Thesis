...
Date: 2024-06-05
Description: This script downsizes all MP4 videos in the current directory to a target height and width,
             and saves the downscaled videos in .mp4 format in a designated directory.
             The script processes all videos together in a batch process.
"""
